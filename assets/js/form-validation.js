...
filter_form.addEventListener('submit', async (e) => {
  ...
  e.stopPropagation();
    ...
    if(op1 === 'Organisation')
    {
        ...
        let response2 = await fetch("http://localhost:8080/demoRest-1.0-SNAPSHOT/api/student/by_org", {
            method: 'POST',
            headers:{
        ...
        // this is alumni part.
        //let p_alumni = document.getElementById('alumni_p');
        let response = await fetch("http://localhost:8080/demoRest-1.0-SNAPSHOT/api/almorg/get_alumni",{
        method: 'POST',
            headers: {
                'Content-Type': 'application/json;charset=utf-8'
            },
    ...
    else if(op1 === 'Year')
    {
        ...
        let response = await fetch("http://localhost:8080/demoRest-1.0-SNAPSHOT/api/student/by_year",{
            method: 'POST',
            headers: {
                'Content-Type': 'application/json;charset=utf-8'
            },
    ...
    else if(op1 === 'Domain')
    {
        ...
        let response = await fetch("http://localhost:8080/demoRest-1.0-SNAPSHOT/api/student/by_domain",{
            method: 'POST',
            headers: {
                'Content-Type': 'application/json;charset=utf-8'
            },
    ...
    else //specialisation
    {
        ...
        let response = await fetch("http://localhost:8080/demoRest-1.0-SNAPSHOT/api/student/get_specialisation",{
            method: 'POST',
            headers: {
                'Content-Type': 'application/json;charset=utf-8'
            },
...
async function button_options(){
    ...
    if(chosen === 'Placed')
    {
        ...
        let response = await fetch("http://localhost:8080/demoRest-1.0-SNAPSHOT/api/student/get_placed");
        if(response['status'] === 500)
        {
            console.log("No Data!!");
    ...
    else if(chosen === 'Not Placed')
    {
        ...
        let response = await fetch("http://localhost:8080/demoRest-1.0-SNAPSHOT/api/student/get_not_placed");
        console.log(response);
        if(response['status'] === 500)
        {
            console.log("No Data!!");
    ...
    else if(chosen === "Organisation")
    {
        ...
        let response = await fetch("http://localhost:8080/demoRest-1.0-SNAPSHOT/api/org/get");
    ...
    else if(chosen === "Year")
    {
        ...
        let response = await fetch("http://localhost:8080/demoRest-1.0-SNAPSHOT/api/student/year");
        let options = await response.json(); // read response body and parse as JSON
        console.log(options);
    ...
    else if(chosen === "Domain")
    {
        ...
        let response = await fetch("http://localhost:8080/demoRest-1.0-SNAPSHOT/api/student/domain");
        let options = await response.json(); // read response body and parse as JSON
        console.log(options);
    ...
    else
    {
        ...
        let response = await fetch("http://localhost:8080/demoRest-1.0-SNAPSHOT/api/student/specialisation");
        let options = await response.json(); // read response body and parse as JSON
        console.log(options);
...
async function fetch_options(){
    let response = await fetch("http://localhost:8080/demoRest-1.0-SNAPSHOT/api/employee/options");
    let options = await response.json(); // read response body and parse as JSON
    console.log(options);
    ...
    let response2 = await fetch("http://localhost:8080/demoRest-1.0-SNAPSHOT/api/student/display_all");
    if(response2['status'] === 500)
    {
        console.log("No Data!!");
