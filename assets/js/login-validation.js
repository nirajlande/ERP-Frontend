...
login_form.addEventListener('submit', async (e) => {
    ...
    if (login_form.checkValidity() === true) {
        ...
        let response = await fetch('http://localhost:8080/demoRest-1.0-SNAPSHOT/api/employee/login', {
            method: 'POST',
            headers: {
...
async function fetch_department(){
    let response = await fetch("http://localhost:8080/demoRest-1.0-SNAPSHOT/api/employee/get");
